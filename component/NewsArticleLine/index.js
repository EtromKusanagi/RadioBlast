...
import { setNews, setNewsVisible } from '../../redux/actions/NewsPageAction'; 
const NewsAticleLine = (props) => {
    return (
        <TouchableOpacity 
            onPress={
                () => {
                    props.setNews(props.news);
                    props.setNewsVisible(!props.newsVisible);
                }
            }
            style={styles.newsLine}
        >
            <View>
                <Image style={styles.newsImage} source={{uri: props.news.thumb}}/>
            </View>
